...
<template>
  <div
    class="flex items-center fixed top-0 w-full h-[var(--sidebar-height)] z-30 bg-bg-topbar dark:bg-bg-darkTopbar border-b border-b-border-topbar dark:border-b-border-darkTopbar"
  >
